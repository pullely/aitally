...
//   - AitallyError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): Aitally {
  return new Aitally({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the Aitally class", () => {
