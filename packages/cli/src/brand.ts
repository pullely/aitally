...
// `@saas/sdk` client class name (`Aitally`) is intentionally NOT part of
...
export const CLI_BIN = "aitally";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "Aitally";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.aitally.app";
