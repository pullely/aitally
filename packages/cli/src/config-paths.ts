...
//   - `~/.config/aitally/credentials.json` (0600)
//   - `~/.config/aitally/config.json`     (0644)
//
// Override via `AITALLY_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/aitally` everywhere
