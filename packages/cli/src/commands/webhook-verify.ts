// `aitally webhook verify` — local cryptographic verification of a
// Aitally outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `aitally login`.
