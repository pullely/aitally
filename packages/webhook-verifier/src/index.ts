 ...
 * signature verifier for Aitally outbound webhook deliveries.
 *
...
/**
 * Compute the canonical Aitally webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a Aitally webhook delivery.
 *
