...
Next.js 15 + [opennextjs/cloudflare](https://github.com/opennextjs/opennextjs-cloudflare) delivery of the Aitally web console.
...
- Per-env Cloudflare Pages projects: `aitally-web-console-next-{dev,stage,prod}`
